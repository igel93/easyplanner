...
var LogInComponent = /** @class */ (function () {
    function LogInComponent(calendarService, router) {
        ...
        this.userOrpasswordWrong = "Username or Password incorrect, please try again.";
        this.valid = false;
    }
        ...
        if (value.password != null && value.username != null) {
            this.calendarService.getUser(value.username, value.password)
                ...
                if (value.password === _this.user.password) {
                    ...
                    _this.warning = _this.userOrpasswordWrong;
                }
            });
        }
        else {
...
var RegisterUserComponent = /** @class */ (function () {
    function RegisterUserComponent(calendarService, router) {
        ...
        this.passwordSame = "The password has to be same one! ";
        this.passwordExist = "The username already exist!";
        this.infoEmpty = "The register information is not allowed empty!  ";
        this.uid = null;
    }
    ...
    RegisterUserComponent.prototype.onSubmit = function (value) {
        ...
        if (value.password1 == value.password2 && value.password1 != null) {
            ...
            this.warning = this.warning + this.value.passwordSame;
        }
        if (this.test == 4) {
            this.calendarService.getUser(this.user.student_id, this.user.password)
                ...
                if (!Object(util__WEBPACK_IMPORTED_MODULE_3__["isNull"])(result)) {
                    _this.warning = _this.value.passwordExist;
                }
                else {
            ...
            this.warning = this.warning + this.value.infoEmpty;
        }
    };
...
module.exports = "<div>\r\n  <h3 style=\"text-align:center\">Change Password</h3>\r\n  <br>\r\n  <div>\r\n    <form (ngSubmit)=\"onSubmit(profileForm.value)\" #profileForm=\"ngForm\">\r\n      <table align='center'>\r\n        <tbody>\r\n          <tr>\r\n            <td> <label>Current:</label></td>\r\n            <td> <input type=\"password\" required [(ngModel)]=oldPassword name=oldPassword></td>\r\n          </tr>\r\n          <tr>\r\n            <td> <label>New:</label></td>\r\n            <td><input type=\"password\" required [(ngModel)]=newPassword1 name=newPassword1></td>\r\n          </tr>\r\n          <tr>\r\n            <td><label>Retype new:</label></td>\r\n            <td><input type=\"password\" required [(ngModel)]=newPassword2 name=newPassword2></td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n      <hr>\r\n      <div style=\"text-align:center\">\r\n        <a>{{warning}}</a>\r\n        <div>\r\n          <button class=\"btn btn-primary\" (click)=\"cancelClick()\">Cancel</button>\r\n          <button class=\"btn btn-primary\" type=\"submit\">Confirm</button>\r\n        </div>\r\n      </div>\r\n    </form>\r\n  </div>\r\n</div>\r\n<router-outlet></router-outlet>"
