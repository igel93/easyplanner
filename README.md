...
Now you can open up your browser and paste in the following url [http://localhost:4200/login] and the application will run. You can alternatively run the command included under to open up the internet browser automatically when you run the front end
```SH
$ ng serve --open
```
